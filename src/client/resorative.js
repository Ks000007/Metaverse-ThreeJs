...
var baseActions2 = {
    suptaBudha: { weight: 0 },
    Padangusthana: { weight: 0 },
    viparitaKarani: { weight: 0 },
};
...
function init() {
    ...
    var baseActions = baseActions2;
    console.log("sitting");
    loader.load('assets/padangusthasana.glb', function(gltf) {
...
const padangustana = new THREE.PositionalAudio(listener);
...
audioLoader.load('sounds/sapta padangusthansana.mp3', function(buffer) {
    padangustana.setBuffer(buffer);
    padangustana.setRefDistance(20);

});
const viparita = new THREE.PositionalAudio(listener);
// suptaBudha: { weight: 0 },
// Padangusthana: { weight: 0 },
// viparitaKarani: { weight: 0 },

audioLoader.load('sounds/viparita karani.mp3', function(buffer) {
    viparita.setBuffer(buffer);
    viparita.setRefDistance(20);

});
const Budha = new THREE.PositionalAudio(listener);

audioLoader.load('sounds/sapta baddha konasana.mp3', function(buffer) {
    Budha.setBuffer(buffer);
    Budha.setRefDistance(20);
...
function animate() {
    ...
    //-8, y: 0.32, z: -3
    if (baseActions2.suptaBudha.weight === 1) {
    ...
    if (baseActions2.Padangusthana.weight === 1) {
        model.rotation.x = -Math.PI / 2;
    ...
    if (baseActions2.viparitaKarani.weight === 1) {
